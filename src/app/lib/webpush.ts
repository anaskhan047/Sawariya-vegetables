...
webpush.setVapidDetails("mailto:shrisawariyamart@gmail.com", publicKey, privateKey);
...
export async function sendPush(subscription: VapidSubscription, payload: PushPayload): Promise<void> {
